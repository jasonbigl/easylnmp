...
#which PHP Version do you want to install?
    ...
    *)
    ...
    MPHP_Menu_Choice="${PHPSelect}"
    case "${MPHP_Menu_Choice}" in
    1) PHPSelect="7.0" ;;
    2) PHPSelect="7.1" ;;
    3) PHPSelect="7.2" ;;
    4) PHPSelect="7.3" ;;
